...
var userSettingsService = "http://pmapi/usersettings/";
...
describe('User Settings Service Tests::', function() {
    ...
    describe('JSON dictionary of key/value string pairs for all user settings for the App::', function() {
        ...
        it("Call to http://pmapi/usersettings returns JSON dictionary", function () {
